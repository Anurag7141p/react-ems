      ...
      {({ setFieldValue }) => (
        <Form>
          <div className="w-full h-screen bg-white">
            ...
            >
              <div className="bg-gray-500/60 rounded-lg w-[50%] min-h-[70%] py-10  gap-6  flex flex-col  justify-center items-center">
                <div>
                  <h1 className="text-3xl font-serif text-[#00165A]">Add User</h1>
                </div>
                <div className="w-full  flex flex-col  justify-center items-center">
                  <input
                    className="appearance-none bg-white w-[60%] border border-gray-300 rounded-md py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-1 focus:ring-blue-400 focus:border-transparent"
